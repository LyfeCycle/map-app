...
@interface LyfeCycle_VersionTwoObject : KrollCoverageObject {
#else
@interface LyfeCycle_VersionTwoObject : KrollObject {
#endif
@private
...
extern NSString * LyfeCycle_VersionTwo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	LyfeCycle_VersionTwoObject *_lyfecycle_versiontwo;
    KrollObject* console;
	BOOL shutdown;
