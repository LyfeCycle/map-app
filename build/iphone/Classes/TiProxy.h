...
//Rare exceptions to indicate a bug in the _lyfecycle_versiontwo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for LyfeCycle_VersionTwo proxies.
 */
