...
// in simulator we redefine to format for LyfeCycle_VersionTwo Developer console
...
{\
	NSString * exceptionName = [@"org.lyfecycle_versiontwo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lyfecycle_versiontwo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UILyfeCycle_VersionTwoNativeItemNone = -1, 
	UILyfeCycle_VersionTwoNativeItemSpinner = -2,
	UILyfeCycle_VersionTwoNativeItemProgressBar = -3,
	
	UILyfeCycle_VersionTwoNativeItemSlider = -4,
	UILyfeCycle_VersionTwoNativeItemSwitch = -5,
	UILyfeCycle_VersionTwoNativeItemMultiButton = -6,
	UILyfeCycle_VersionTwoNativeItemSegmented = -7,
	
	UILyfeCycle_VersionTwoNativeItemTextView = -8,
	UILyfeCycle_VersionTwoNativeItemTextField = -9,
	UILyfeCycle_VersionTwoNativeItemSearchBar = -10,
	
	UILyfeCycle_VersionTwoNativeItemPicker = -11,
	UILyfeCycle_VersionTwoNativeItemDatePicker = -12,
	
	UILyfeCycle_VersionTwoNativeItemInfoLight = -13,
	UILyfeCycle_VersionTwoNativeItemInfoDark = -14,
	
	UILyfeCycle_VersionTwoNativeItemDisclosure = -15,
	
	UILyfeCycle_VersionTwoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all LyfeCycle_VersionTwo instances of
