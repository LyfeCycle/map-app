...
/**
 Base class for all LyfeCycle_VersionTwo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the LyfeCycle_VersionTwo view hierarchy (such as wrapped iOS UIViews) was touched.
