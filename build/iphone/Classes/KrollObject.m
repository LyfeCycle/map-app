...
//@interface LyfeCycle_VersionTwoObject : NSObject
//@end

@interface LyfeCycle_VersionTwoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LyfeCycle_VersionTwoObject class]])
		{
			for (NSString *key in [[(LyfeCycle_VersionTwoObject*)o modules] allKeys])
			{
