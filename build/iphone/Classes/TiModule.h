...
/**
 The base class for all LyfeCycle_VersionTwo modules
 */
...
/**
 LyfeCycle_VersionTwo Platform calls this method on startup.
 */
-(void)startup;

/**
 LyfeCycle_VersionTwo Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 LyfeCycle_VersionTwo Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 LyfeCycle_VersionTwo Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 LyfeCycle_VersionTwo Platform calls this method on resume.
 @param sender The sender of the event.
 */
