 ...
 * to send analytic data that can be viewed on the LyfeCycle_VersionTwo Dashboard.
 *
 * For information on getting started with LyfeCycle_VersionTwo Platform Services,
